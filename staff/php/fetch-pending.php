    ...
    $output = '
     ...
     <thead>
            <tr>
              ...
              <th scope="col" class="table-info">view details</th>
            </tr>
          </thead>
          <tbody>
     ';
     $email = $_SESSION['email'];
     $sql = "SELECT * FROM lead where  assign = '$email' AND stat = 'pend'";
     ...
     foreach($result as $row){
        ...
        <td><button class="btn btn-sm btn-glow btn-info comp" data-id="'.$row['id'].'">Completed</button></td>
        ...
        <td><button class="btn btn-secondary btn-sm mt-0.6 det" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="'.$row['id'].'" >view details</button></td>
        </tr>
        </tbody>';
     }
